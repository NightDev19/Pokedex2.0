            ...
            >
                ...
                >
                    ...
                    >
                        <!-- Header -->
                        <div
                            class="flex justify-between items-center p-6 border-b bg-gradient-to-r from-blue-50 to-purple-50"
                        >
                            <div class="flex items-center gap-4">
                                <div
                                    class="w-16 h-16 rounded-full overflow-hidden bg-white shadow-md"
                                >
                                    <img
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="space-y-2">
                                            <div
                                                v-for="stat in pokemon.stats.slice(
                                                    0,
                                                    3,
                                                )"
                                                :key="stat.stat.name"
                                            ...
                                            >
                                                <span
                                                    class="text-sm font-medium capitalize w-16 text-gray-600"
                                                >
                                                    {{
                                                        getStatName(
                                                            stat.stat.name,
                                                ...
                                                <span
                                                    class="text-sm font-semibold w-8 text-right"
                                                    >{{ stat.base_stat }}</span
                                                >
                                            </div>
                                        </div>
                        ...
                        <!-- Footer -->
                        <div
                            class="flex justify-between items-center p-6 border-t bg-gray-50"
                        >
